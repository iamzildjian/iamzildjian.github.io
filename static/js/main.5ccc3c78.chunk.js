(this.webpackJsonpgallery = this.webpackJsonpgallery || []).push([
	[0], {
		119: function(A, t, e) {
			"use strict";
			e.r(t);
			...
			function d(A) {
				var t = A.photos,
					...
					h = A.margin,
					o = A.onLoad,
					c = Object(g.useState)(0),
					w = Object(n.a)(c, 2),
					d = w[0],
					U = w[1],
					R = Object(g.useRef)(null);
				Object(g.useLayoutEffect)((function() {
					var A = null,
						t = new l.a((function(t) {
							var e = t[0].contentRect.width;
							d !== e && (A = window.requestAnimationFrame((function() {
								U(Math.floor(e))
							})))
						}));
					return t.observe(R.current),
						function() {
							t.disconnect(), window.cancelAnimationFrame(A)
						}
				}));
				var f = Object(g.useMemo)((function() {
						var A = function(A) {
								var t = 1;
								return A >= 500 && (t = 2), A >= 900 && (t = 3), A >= 1500 && (t = 4), A >= 2200 && (t = 5), A >= 3e3 && (t = 6), A >= 3800 && (t = 7), A >= 4500 && (t = 8), A >= 5300 && (t = 9), t
							}(d),
							e = function(A) {
								for (var t = A.photos, e = A.columns, g = A.containerWidth, i = A.margin, h = (g - 2 * i * e) / e, o = t.map((function(A) {
										var t = A.height / A.width * h;
										return Object(s.a)(Object(s.a)({}, A), {}, {
											width: a(h, 1),
											height: a(t, 1)
										})
									})), n = [], r = [], c = 0; c < e; c++) n[c] = a(c * (h + 2 * i), 1), r[c] = 0;
								var l = o.map((function(A) {
									var t = r.reduce((function(A, t, e) {
										return t < r[A] ? e : A
									}), 0);
									A.top = r[t], A.left = n[t], r[t] = r[t] + A.height + 2 * i;
									var e = r.reduce((function(A, t, e) {
										return t > r[A] ? e : A
									}), 0);
									return A.containerHeight = r[e], A
								}));
								return l
							}({
								containerWidth: d - 1,
						...
						return e.length > 0 && (g.height = e[e.length - 1].containerHeight), [e, g]
					}), [d, h, t]),
					p = Object(n.a)(f, 2),
					J = p[0],
					u = p[1],
					m = Object(g.useCallback)((function(A, g) {
						var i = g.index;
						e(A, {
							index: i,
							photo: t[i],
				...
				var j = Object(g.useMemo)((function() {
					return Array.from({
						length: t.length
					}, E)
				}), [t.length]);
			...
			function f(A) {
				var t = A.viewerIsOpen,
					e = A.photos,
					g = A.currentPhoto,
					i = A.closeLightbox;
				return Object(r.jsx)(R.b, {
					children: t ? Object(r.jsx)(R.a, {
						onClose: i,
						children: Object(r.jsx)(R.c, {
							currentIndex: g,
							showNavigationOnTouchDevice: !0,
							views: e.map((function(A) {
								var t = A.src,
									e = A.title,
									g = A.size,
									i = g.height;
			...
			function m(A) {
				var t = A.getBoundingClientRect(),
					...
					i = t.top <= e && t.top + t.height >= 0,
					h = t.left <= g && t.left + t.width >= 0;
				return !(!i || !h) || t.left >= 0 && t.top >= 0 && t.left + t.width <= g && t.top + t.height <= e
			}

			function B(A) {
				if (A && A.length && !A.every((function(A) {
						return !A
					}))) {
					var t = Array.from({
							length: A.length
						...
						e = function(A, t) {
							...
							return function() {
								var h = this,
									o = arguments;
								if (!e) return e = !0, A.apply(h, o), void(i = Date.now());
								clearTimeout(g), g = setTimeout((function() {
									Date.now() - i >= t && (A.apply(h, o), i = Date.now())
								}), Math.max(t - (Date.now() - i), 0))
							}
						}(i, 120);
					window.addEventListener("scroll", e, !1), setTimeout(i, 0)
				}

				function g(A, e) {
					var g = new Image,
						i = A.dataset.original;
					g.src = i, g.onload = function() {
						A.classList.add("loaded"), A.src = i, t[e] = !0
					}, g.onerror = function() {
						t[e] = !0
					}
				}
				...
				function i() {
					if (t.every((function(A) {
						...
						for (var i = 0; i < A.length; ++i) !t[i] && m(A[i]) && g(A[i], i)
				}
			}
			var j, O = (j = [{
				src: "assets/photos/a.jpg",
				title: "a",
				alt: "a",
				width: 39,
				height: 29,
				...
				return Object(s.a)(Object(s.a)({}, e), {}, {
					src: t.replace(/((.jpg)|(.jpeg)|(.png))$/, ".webp")
				})
			})) : j);
			var S = function() {
				var A = Object(g.useState)(0),
					t = Object(n.a)(A, 2),
					e = t[0],
					i = t[1],
					h = Object(g.useState)(!1),
					o = Object(n.a)(h, 2),
					l = o[0],
					s = o[1],
					a = Object(g.useCallback)((function(A, t) {
						t.photo;
						var e = t.index;
						i(e), s(!0)
					}), []),
					w = Object(g.useCallback)((function() {
						i(0), s(!1)
					}), []);
			...
			o.a.render(Object(r.jsx)(i.a.StrictMode, {
